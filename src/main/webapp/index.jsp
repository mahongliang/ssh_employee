...
<body>
		...
		<div class="loginBox">
			...
			<div class="login_cont">
				<ul class="login">
					...
					<li class="mb_10"><input type="password"
						class="login_input user_icon" name="password"></li>
	...
	<div class="footer">
		...
		<p class="web">
			<a href="#"><img src="<%=basePath %>images/webLogo.jpg" alt="logo"></a><a
				href="#"><img src="<%=basePath %>images/webLogo.jpg" alt="logo"></a><a
				href="#"><img src="<%=basePath %>images/webLogo.jpg" alt="logo"></a><a
				href="#"><img src="<%=basePath %>images/webLogo.jpg" alt="logo"></a>
		</p>
	</div>
</body>
</html>
