...
<td align="center"><a href="<%=basePath %>department_edit.action?did=<s:property value="#d.did"/>"><img src="<%=basePath %>images/编辑.png"></a></td>
<td align="center"><a href="<%=basePath %>department_delete.action?did=<s:property value="#d.did"/>"><img src="<%=basePath %>images/删除.png"></a></td>
</tr>
